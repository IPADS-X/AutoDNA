...
namespace CYStandardProcedure
{
    public static class iniHelper
    {
            ...
            /// <returns></returns>
            public static List<string>  GetAllKeyValues(string section, out string[] keys, out string[] values, string path)
            {
        ...
        /// <param name="path">INI文件路径</param>
        /// <returns></returns>
        public static string[] GetAllKeys(string section, out string[] keys, string path)
            {
            int i;
