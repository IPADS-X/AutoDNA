...
### Dependency Installation Commands (apt)
```bash
sudo apt update
sudo apt install -y build-essential cmake libmodbus-dev nlohmann-json3-dev libspdlog-dev libfmt-dev libssl-dev
```
