...
public:
    ...
    static const int ASPIRATATION_SPEED_ADDR  = 51212;
    static const int DISPENSE_SPEED_ADDR      = 51213;
    static const int BLOW_OUT_ADDR            = 51214;
    static const int AIR_GAP_VOLUME_ADDR      = 51215;
    static const int FREE_DISPENSE_ADDR       = 51216;
    static const int TIP_TOUCHING_ADDR        = 51217;
};
