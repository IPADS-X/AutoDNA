...
public:
    ...
    bool isUselessTube(std::shared_ptr<Container> tube) {
        return tube_manager_.isUselessTube(tube);
    }
    ...
    bool renewPipettes(MachineTypeId machine_type, std::shared_ptr<MachineManager> mac_manager);
    ...
    void Print() { tube_manager_.Print(); }
