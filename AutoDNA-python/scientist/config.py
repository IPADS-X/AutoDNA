...
external_libs_path = os.path.join(input_path, "libraries")
external_libs_list_path = os.path.join(external_libs_path, "tools_list.txt")
reference_list_path = os.path.join(external_libs_path, "reference_list.txt")
external_libs_usage_path = os.path.join(external_libs_path, "tools.txt")
...
class AppConfig:
    ...
    def __init__(self):
        ...
        self.detection = False # DNA storage, detection
        ...
        self.interruptible = True # default is interruptible
        self.chat_series = "gemini"
