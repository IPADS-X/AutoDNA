...
from config import output_path, mock_path, settings, input_manual_mappings_path, manual_path, protocol_mode
...
def Protocol(experiment_name: str, pure_software = False, retry = False, file_ids: list[str] = [], manuals: list[str] = []):
    ...
    prompt2 = PromptTemplate.from_template(
        ...
        {procedure}
        Reaction condition like temperature, repeat times should be included in the action. Keep in mind that tube has a maxium capacity of 200uL, thus the volume of any reaction solution should be less than 200uL.
        """
