...
from llm.model import paper_qa_model, paper_qa_key, paper_qa_key_qwen, paper_qa_model_qwen, qwen_api_base
...
def answer_one_question(question, suffix=None, mock=False, save=False, filter=None):
    ...
    if settings.chat_series == "qwen":
        model = paper_qa_model_qwen
    
    # set environment variable GEMINI_API_KEY
    os.environ["GEMINI_API_KEY"] = paper_qa_key
    os.environ["OPENAI_API_KEY"] = paper_qa_key_qwen
    os.environ["OPENAI_API_BASE"] = qwen_api_base
