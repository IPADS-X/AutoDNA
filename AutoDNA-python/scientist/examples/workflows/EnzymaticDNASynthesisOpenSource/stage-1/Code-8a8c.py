...
pipette.transfer(volume=2500.0, source=bw_buffer_2x, destination=bw_buffer_1x)
pipette.transfer(volume=2500.0, source=water, destination=bw_buffer_1x)
pipette.mix(volume=800.0, location=bw_buffer_1x, repetitions=10)
...
for nucleotide in SEQUENCE:
    ...
    wash_step(reaction_tube, bw_buffer_1x, waste_container)
...
pipette.transfer(volume=50.0, source=bw_buffer_1x, destination=reaction_tube)
