...
intermediate_products_prompt = PromptTemplate.from_template(
"""        
Analyze the provided execution log text and identify all unique names of containers mentioned as holding the final output of a process.
Look for specific labels or phrases that indicate a container name or similar context indicating where a result is stored.
        
Return ONLY a raw JSON list of strings containing the extracted names. Do not include markdown formatting, code blocks, or any explanatory text.
